...
<template>
  <component
    :is="as"
    :class="[
      'relative inline-block overflow-hidden !bg-transparent !border-none !rounded-[20px] md:w-48 w-32',
      customClass,
    ]"
    v-bind="restAttrs"
  ...
  >
    ...
    <div
      class="relative z-10 border border-[#333] bg-[#0b0b0b] text-white text-[16px] text-center md:px-6 px-2 py-3 rounded-[20px]"
    >
      <slot />
    </div>
  </component>
